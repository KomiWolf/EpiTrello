...
--
-- Table structure for table `active_oauth`
--

DROP TABLE IF EXISTS `active_oauth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `active_oauth` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `token` mediumtext NOT NULL,
  `token_expiration` datetime DEFAULT NULL,
  `token_lifespan` bigint(20) unsigned DEFAULT NULL,
  `refresh_link` mediumtext DEFAULT NULL,
  `user_id` bigint(20) unsigned NOT NULL,
  `provider_id` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `active_oauth_unique` (`token`) USING HASH,
  KEY `active_oauth_users_FK` (`user_id`),
  KEY `active_oauth_oauth_providers_FK` (`provider_id`),
  CONSTRAINT `active_oauth_oauth_providers_FK` FOREIGN KEY (`provider_id`) REFERENCES `oauth_providers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `active_oauth_users_FK` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `active_oauth`
--

LOCK TABLES `active_oauth` WRITE;
/*!40000 ALTER TABLE `active_oauth` DISABLE KEYS */;
/*!40000 ALTER TABLE `active_oauth` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `cards_label`
--
...
CREATE TABLE `cards_label` (
  ...
  `card_id` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `cards_label_lists_cards_FK` (`card_id`),
  CONSTRAINT `cards_label_lists_cards_FK` FOREIGN KEY (`card_id`) REFERENCES `lists_cards` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cards_label`
--

LOCK TABLES `cards_label` WRITE;
/*!40000 ALTER TABLE `cards_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `cards_label` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `oauth_providers` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `provider_name` mediumtext NOT NULL,
  `client_id` mediumtext NOT NULL,
  `client_secret` mediumtext NOT NULL,
  `provider_scope` mediumtext NOT NULL,
  `authorisation_base_url` mediumtext NOT NULL,
  `token_grabber_base_url` mediumtext NOT NULL,
  `user_info_base_url` mediumtext NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `oauth_providers_unique` (`provider_name`) USING HASH,
  UNIQUE KEY `oauth_providers_unique_1` (`client_id`) USING HASH,
  UNIQUE KEY `oauth_providers_unique_2` (`client_secret`) USING HASH,
  UNIQUE KEY `oauth_providers_unique_3` (`authorisation_base_url`) USING HASH,
  UNIQUE KEY `oauth_providers_unique_4` (`token_grabber_base_url`) USING HASH,
  UNIQUE KEY `oauth_providers_unique_5` (`user_info_base_url`) USING HASH
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='The table that store every users data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `workspaces_invitations` (
  ...
  KEY `workspace_invitation_workspace_FK` (`workspace_id`),
...
-- Dump completed on 2025-02-14 23:34:57
