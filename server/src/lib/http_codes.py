"""
The file that contains every possible http code for sending response
"""
...
class HttpCodes:
    ...
    * The 5xx: Server error
    ...
    def _check_data_type(self, data_type: Union[str, None] = None) -> str:
        ...
        Args:
            data_type (str, optional): . Defaults to None.

        Returns:
            str: : Returns the correct known version of the sent data.
        """
    ...
    def _check_header(self, header: Union[Mapping[str, str], None] = None) -> Any:
        ...
        Args:
            header (Mapping[str, str], optional): . Defaults to None.
        Returns:
