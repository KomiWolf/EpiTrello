...
class SQLManageConnections:
    """
    The class that manage the connection with the sql database
    """
    ...
    def __init__(self, url: str, port: int, username: str, password: str, db_name: str, success: int = 0, error: int = 84, debug: bool = False) -> None:
        ...
        Args:
            ...
            password (str): 
            db_name (str): 
            succes (int, optional): . Defaults to 0.
    ...
    def initialise_pool(self) -> int:
        ...
        Raises:
            RuntimeError: : A runtime error is raised if it fails.

        Returns:
            int: : Returns self.success if the function succeeds.
        """
    ...
    def get_connection(self) -> mysql.connector.pooling.PooledMySQLConnection:
        ...
        Returns:
            mysql.connector.pooling.PooledMySQLConnection: : A pooled connection
        """
